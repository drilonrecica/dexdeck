package dev.dexdeck.bridge.agp8;
...
/** Adapter compiled against the minimum supported AGP 8 public API. */
public final class Agp8ModelAdapter implements ModelAdapter {
    @Override
